...
const QuadServices: React.FC<kiteServicesProps> = ({}) => {
  const t = useTranslations("SurfLessonsPrivate");
  const t1 = useTranslations("SurfLessonsSemi");
  const t2 = useTranslations("SurfLessonsCol");
  return (
      ...
      <Container>
        <div className="flex flex-col">
          ...
          <div className="gap-8 pb-10 pt-5  grid grid-col-1 sm:grid-cols-2 lg:grid-cols-3  ">
            <ServiceCard
              imageSrc="/ourservices/surf/private.jpeg"
              title={t("t")}
              price={t("price")}
              description={t("d1")}
              services={[
            ...
            />
            <ServiceCard
              imageSrc="/ourservices/surf/semi.jpeg"
              title={t1("t")}
              price={t1("price")}
              description={t1("d1")}
              services={[
            ...
            />
            <ServiceCard
              imageSrc="/ourservices/surf/group.jpeg"
              title={t2("t")}
              price={t2("price")}
              description={t2("d1")}
              services={[
