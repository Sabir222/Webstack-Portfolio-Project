...
const ServicesTable: React.FC<TableProps> = ({}) => {
  ...
  const sc1 = useTranslations("Surfcol1");
  const sc2 = useTranslations("Surfcol2");
  const sc3 = useTranslations("Surfcol3");
  return (
          ...
          <TableRow>
            ...
            <TableHead className="flex flex-col h-auto items-center gap-2">
              ...
              <div className=" text-primaryColor flex gap-1">
                <p className="text-2xl leading-none ">{sc1("p")}</p>
              </div>
            ...
            <TableHead>
              <div className="flex flex-col h-auto items-center gap-2">
                ...
                <div className=" text-primaryColor flex gap-1">
                  <p className="text-2xl leading-none ">{sc2("p")}</p>
                </div>
                <Button
                  className="mx-auto rounded-full mb-2"
                  onClick={() => router.push("/booking")}
            ...
            <TableHead>
              <div className="flex flex-col h-auto items-center gap-2">
                ...
                <div className=" text-primaryColor flex gap-1">
                  <p className="text-2xl leading-none ">{sc3("p")}</p>
                </div>
                <Button
                  className="mx-auto rounded-full mb-2"
                  onClick={() => router.push("/booking")}
